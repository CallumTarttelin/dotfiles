    ...
    ColumnLayout {
      ...
      NBox {
        ...
        ColumnLayout {
          ...
          RowLayout {
            ...
            NIconButton {
              icon: "refresh"
              tooltipText: pluginApi?.tr("panel.scan")
            ...
            NIconButton {
              ...
              onClicked: {
                if (root.pluginApi)
                  root.pluginApi.togglePanel(null);
              }
            }
          }
          ...
          RowLayout {
            ...
            Repeater {
              model: [
                pluginApi?.tr("panel.tab.available"),
                pluginApi?.tr("panel.tab.saved")
              ]
      ...
      NBox {
        ...
        RowLayout {
            ...
            NText {
              text: {
                if (Lib.IwdService.state === "unavailable")
                  return pluginApi?.tr("panel.status.unavailable");
                if (Lib.IwdService.actionInProgress)
                  return pluginApi?.tr("panel.status.connecting");
                return Lib.IwdService.connected ? Lib.IwdService.ssid : pluginApi?.tr("panel.status.not-connected");
              }
          ...
          NButton {
            visible: Lib.IwdService.connected
            text: pluginApi?.tr("panel.status.disconnect")
      ...
      NBox {
        ...
        ColumnLayout {
          ...
          NText {
            text: pluginApi?.tr("panel.passphrase.title", { "network": root.connectingNetwork })
            pointSize: Style.fontSizeM
            color: Color.mOnSurface
          }
          ...
          RowLayout {
            ...
            // NTextInput doesn't expose echoMode, so TextField is required here
            TextField {
              id: passphraseField
              Layout.fillWidth: true
              echoMode: TextInput.Password
              placeholderText: pluginApi?.tr("panel.passphrase.placeholder")
              color: Color.mOnSurface
              font.pointSize: Style.fontSizeM
              background: Rectangle {
                color: Color.mSurface
                radius: Style.iRadiusM
                border.color: passphraseField.activeFocus ? Color.mSecondary : Color.mOutline
            ...
            NButton {
              text: pluginApi?.tr("panel.passphrase.connect")
      ...
      ColumnLayout {
        ...
        NText {
          text: Lib.IwdService.scanning
            ? pluginApi?.tr("panel.networks.scanning")
            : pluginApi?.tr("panel.networks.available")
          pointSize: Style.fontSizeS
        ...
        NScrollView {
          ...
          ColumnLayout {
              ...
              NBox {
                ...
                RowLayout {
                  ...
                  NText {
                    ...
                    text: pluginApi?.tr("panel.status.connected")
                    pointSize: Style.fontSizeS
            ...
            NText {
              ...
              text: pluginApi?.tr("panel.networks.empty")
              pointSize: Style.fontSizeM
              color: Color.mOnSurfaceVariant
      ...
      ColumnLayout {
        ...
        NText {
          text: pluginApi?.tr("panel.known.title")
          pointSize: Style.fontSizeS
          color: Color.mOnSurfaceVariant
        }
        ...
        NScrollView {
          ...
          ColumnLayout {
            ...
            Repeater {
              ...
              NBox {
                ...
                RowLayout {
                  ...
                  NIconButton {
                    icon: "trash-2"
                    tooltipText: pluginApi?.tr("panel.known.forget")
            ...
            NText {
              ...
              text: pluginApi?.tr("panel.known.empty")
              pointSize: Style.fontSizeM
              color: Color.mOnSurfaceVariant
              Layout.alignment: Qt.AlignHCenter
              Layout.topMargin: Style.marginXL
