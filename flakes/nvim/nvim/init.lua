...
function Blink_lsp_capabilities(override, include_nvim_defaults)
...
require("lz.n").load {
  ...
  },
  {
    ...
    after = function()
      ...
      for server, config in pairs(servers) do
        -- config.capabilities = Blink_lsp_capabilities(config.capabilities)
  ...
  },
  {
    ...
    before = function()
      ...
      require('lz.n').trigger_load('cmp_luasnip')
      require('lz.n').trigger_load('cmp-nvim-lsp')
      require('lz.n').trigger_load('cmp-path')
      require('lz.n').trigger_load('cmp-nvim-lsp-signature-help')
    end,
    after = function()
  ...
  },
  {
    ...
    opts = {
      ...
      keymap = {
        ...
        -- Scroll the documentation window backward/forward (by 4 lines by default)
        ['<C-b>'] = { "scroll_documentation_up" },
        ['<C-f>'] = { "scroll_documentation_down" },

        -- Accept the completion (selects the current or first item)
        ['<C-y>'] = { "accept" },

        -- Manually trigger a completion
        ['<C-m>'] = { "show" },

        -- Snippet navigation: jump forward/backward in snippet placeholders.
        -- These commands assume you have snippet support (e.g. via LuaSnip) integrated.
        ['<C-l>'] = { "snippet_forward" },
